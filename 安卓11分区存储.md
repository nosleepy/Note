...
D/wlzhou: context.getExternalFilesDirs(null) = /storage/emulated/0/Android/data/com.grandstream.myapplication/files,/storage/B06B-111B/Android/data/com.grandstream.myapplication/files
```
